---
title: "Model Stacking with MachineShop"
author: "TopDog"
...
```{r overview_modelinfo}
library(MachineShop) # devtools::install_github("brian-j-smith/MachineShop")
...
knitr::include_graphics("images/FigModelDAG.png")
```
...
knitr::include_graphics("images/FigNestedCV.png")
```
